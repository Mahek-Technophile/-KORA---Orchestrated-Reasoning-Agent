...
export const SYNTHETIC_DISCLAIMER = "Synthetic demonstration data prepared for KORA AI Research Lab Case Study. Not official corporate documentation.";

export const KORA_POLICIES: PolicyDocument[] = [
  // ==========================================
  // HR POLICIES
  // ==========================================
  {
    id: "KORA-HR-POL-001-V3",
    domain: "HR",
    ...
    expiryDate: null,
    supersedesId: "KORA-HR-POL-001-V2",
    ...
    chunks: [
      ...
      },
      {
        ...
        content: "KORA provides 16 weeks of fully paid parental leave for primary caregivers following birth, adoption, or foster placement, and 6 weeks of fully paid leave for secondary caregivers. Must be taken within the first 12 months following the qualifying event.",
  ...
  },
  {
    ...
    supersededById: "KORA-HR-POL-001-V3",
  ...
  },
  {
    ...
    chunks: [
      {
        chunkId: "HR-009-C1",
        documentId: "KORA-HR-EXEC-009-V2",
  ...
  // ==========================================
  {
    ...
    effectiveDate: "2026-01-01",
    expiryDate: null,
    supersedesId: "KORA-FIN-POL-101-V2",
    authorityLevel: "VP_LEVEL",
    accessLevel: "EMPLOYEE",
    status: "ACTIVE",
    summary: "Mandates allowable travel expenses, per diem meals, airline cabin classes, hotel caps, and approval workflows across all KORA operating units.",
    chunks: [
      {
        chunkId: "FIN-101-C1",
        documentId: "KORA-FIN-POL-101-V3",
  ...
  },
  {
    ...
    effectiveDate: "2024-01-01",
    expiryDate: "2025-12-31",
    supersededById: "KORA-FIN-POL-101-V3",
    authorityLevel: "DIRECTOR",
    accessLevel: "EMPLOYEE",
    status: "SUPERSEDED",
    ...
    chunks: [
      {
        ...
        documentId: "KORA-FIN-POL-101-V2",
  ...
  },
  {
    ...
    chunks: [
      {
        chunkId: "FIN-109-C1",
        documentId: "KORA-FIN-DISC-109-V1",
  ...
  // ==========================================
  {
    id: "KORA-CS-WARR-201-V4",
    domain: "SUPPORT",
    department: "Global Customer Experience & Quality Assurance",
    title: "KORA Signature Plumbing & Smart Fixture Warranty Guidelines",
    version: "v4.0",
    ...
    accessLevel: "PUBLIC",
    status: "ACTIVE",
    summary: "Outlines warranty coverage tiers for vitreous china, cast iron enameled baths, faucets, and intelligent smart fixtures (Horizon 2.0, Veil, Innate).",
    chunks: [
      {
        chunkId: "CS-201-C1",
        documentId: "KORA-CS-WARR-201-V4",
        section: "Section 1.2: Residential Plumbing Fixtures Warranty",
        content: "KORA warrants vitreous china fixtures (toilets, lavatories) and cast iron enameled bathtubs to be free of manufacturing defects for the lifetime of original residential ownership. Chrome and PVD finish coatings carry a Lifetime Limited Warranty against corrosion and tarnishing under normal residential use.",
      ...
      },
      {
        chunkId: "CS-201-C2",
        documentId: "KORA-CS-WARR-201-V4",
        section: "Section 2.4: Intelligent Fixtures & Electronic Components",
        content: "Electronic components, bidet seats, heating elements, sensors, and remote controls for KORA Intelligent Fixtures (including Horizon 2.0, Veil, and Innate) are covered under a Three-Year (3-Year) Limited Warranty from original date of installation. Labor coverage for certified technician dispatch is included for the first 12 months. Commercial installations are limited to a One-Year warranty.",
        keywords: ["intelligent toilet", "horizon", "veil", "bidet", "smart toilet", "smart fixture", "electronics warranty", "3 year", "repair"],
        accessLevel: "PUBLIC",
        effectiveDate: "2025-09-01",
        version: "v4.0"
      },
  ...
  // ==========================================
  {
    ...
    accessLevel: "EMPLOYEE",
    status: "ACTIVE",
    summary: "Governs telemetry, user voice recordings, mobile app diagnostics, and personally identifiable information (PII) collected via KORA Connect and smart home devices.",
    chunks: [
      {
        chunkId: "PRV-301-C1",
        documentId: "KORA-PRV-DATA-301-V3",
        section: "Section 3.1: Customer PII Classification & Data Minimization",
        content: "Customer Personally Identifiable Information (PII) collected through KORA Connect applications, warranty registrations, or support tickets is classified as 'Restricted Enterprise Data'. Telemetry and voice interaction logs from KORA Connect smart fixtures must be pseudononymized at edge ingest and purged within 90 days unless explicit customer opt-in is registered.",
        keywords: ["privacy", "pii", "smart home", "telemetry", "iot", "kora connect", "data classification", "voice logs"],
        accessLevel: "EMPLOYEE",
        effectiveDate: "2026-01-01",
        version: "v3.0"
      },
  ...
  // ==========================================
  {
    ...
    chunks: [
      {
        chunkId: "LEG-401-C1",
        documentId: "KORA-LEG-VEND-401-V3",
      ...
      },
      {
        ...
        content: "In the event of suspected or verified unauthorized exposure of restricted KORA data hosted by an external vendor, the vendor is contractually mandated to notify KORA Legal Incident Response within 24 hours of discovery. Legal counsel manages required regulatory notifications to federal and international authorities (e.g., GDPR 72-hour regulatory disclosure deadline).",
  ...
  },
  {
    ...
    chunks: [
      {
        chunkId: "LEG-409-C1",
        documentId: "KORA-LEG-COMP-409-V1",
        section: "Section 3.1: Privilege & Investigation Escalation",
        content: "All complaints submitted via the KORA Integrity Hotline alleging executive financial misconduct, regulatory non-compliance, or antitrust violations are routed directly to the Chief Legal Officer and the Audit Committee of the Board of Directors under attorney-client privilege. Retaliation of any form results in immediate termination of employment.",
