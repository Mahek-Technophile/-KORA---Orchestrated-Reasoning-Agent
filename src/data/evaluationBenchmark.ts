...
export const EVALUATION_BENCHMARK_CASES: BenchmarkCaseDefinition[] = [
  {
    ...
    expectedDocIds: ["KORA-FIN-POL-101-V3"],
  ...
  },
  {
    ...
    expectedDocIds: ["KORA-PRV-DATA-301-V3", "KORA-LEG-VEND-401-V3", "KORA-CS-WARR-201-V4"],
    expectedConflict: false,
    expectedAccessAllowed: true,
    expectedFormat: "CHAT",
  ...
  },
  {
    ...
    role: "EMPLOYEE",
    expectedDomains: ["FINANCE"],
    expectedDocIds: ["KORA-FIN-DISC-109-V1"],
    expectedConflict: false,
  ...
  },
  {
    ...
    role: "EMPLOYEE",
    expectedDomains: ["FINANCE"],
    expectedDocIds: ["KORA-FIN-POL-101-V3", "KORA-FIN-POL-101-V2"],
  ...
  },
  {
    ...
    expectedDocIds: ["KORA-PRV-DATA-301-V3", "KORA-LEG-VEND-401-V3"],
    expectedConflict: false,
    expectedAccessAllowed: true,
    expectedFormat: "EMAIL",
