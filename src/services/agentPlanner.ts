...
export async function executeAgentWorkflow(
  ...
  if (isAccessAllowed && callServerGemini && !isExcelTask && requestedFormat === 'CHAT') {
    try {
      const geminiPrompt = `You are the KOHLER Enterprise Intelligence Agent. Answer this employee query accurately and concisely based strictly on the retrieved policies below. Cite document IDs and sections.
Query: "${query}"
Retrieved Policies:
